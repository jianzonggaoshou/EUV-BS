...
class AddTest(unittest.TestCase):
    ...
    def test1_userBuild(self):
        ...
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/div[2]/div/div/form/div[7]/span/div/div/button').click()
    ...
    def test3_departBuild(self):
        ...
        sleep(3)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[1]/input').send_keys(
            AddTest.depart)
        # 部门类型
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[2]/select').click()
        sleep(1)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[2]/select/option[2]').click()
        # 备注
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[3]/textarea').send_keys(u'部门test')
        # 确定
        ...
        sleep(3)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[1]/input').send_keys(AddTest.group)
        # 部门类型
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[2]/select').click()
        sleep(1)
        ...
        # 备注
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav2-content/div[2]/div/div/form/div[3]/textarea').send_keys(
            u'班组test')
        # 确定
        self.browser.find_element_by_xpath('//*[@id="footer"]/button[1]').click()
        # # 截图
    ...
    def test5_detectionBuild(self):
        ...
        sleep(2)
        self.browser.find_element_by_xpath(
            '//html/body/div/index-header/div[2]/nav5-content/div[2]/div/p[2]/input').send_keys(u'检测项定性test')
        sleep(1)
        ...
        sleep(2)
        self.browser.find_element_by_xpath(
            '//html/body/div/index-header/div[2]/nav5-content/div[2]/div/p[2]/input').send_keys(u'检测项定量test')
        sleep(1)
        self.browser.find_element_by_xpath('//*[@id="elect"]/input[2]').click()
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[2]/div/div[2]/p[1]/input').send_keys(
            'kV')  # ********************巡检项管理新增******************
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[2]/div/div[2]/p[2]/input').send_keys(
            '1')  # ********************巡检项管理新增******************
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[2]/div/div[2]/p[3]/input').send_keys('10')
        # 保存
        sleep(1)
        self.browser.find_element_by_id('all-sava1').click()
        ...
        sleep(2)
        self.browser.find_element_by_xpath(
            '//html/body/div/index-header/div[2]/nav5-content/div[2]/div/p[2]/input').send_keys(u'检测项拍照test')
        sleep(1)
        ...
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[4]/div/div[1]/form/div[2]/textarea').send_keys(u'test')
        # 确定
        ...
        sleep(1)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[5]/div/div[1]/input').click()
        sleep(1)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[5]/div/div[2]/input').click()
        sleep(1)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[5]/div/div[3]/input').click()
        # 确定
        sleep(2)
        self.browser.find_element_by_xpath(
            '/html/body/div/index-header/div[2]/nav5-content/div[5]/div/p[4]/button[1]').click()
        # # 截图
        # sleep(3)
        # now = time.strftime('%y-%m-%d-%H:%M:%S')
