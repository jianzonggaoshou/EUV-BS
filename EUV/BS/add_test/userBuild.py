...
class UserBuild(unittest.TestCase):

	def setUp(self):
		print("userBuild case start"),
	...
	def tearDown(self):
		print("userBuild case end")
		sleep(10)
		self.browser.quit()

	def test_userBuild(self):
		# 滚动翻页
		...
		# 表单
		self.browser.find_elements_by_xpath('//*[@id="name"]')[0].send_keys(u'xuzhentest')
