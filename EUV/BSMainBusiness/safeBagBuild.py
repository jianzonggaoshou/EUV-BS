...
class MainBusinessBuild(unittest.TestCase):
    ...
    def test9_BSSafeBagBuild(self):
        ...
        # 安全包详情
        sleep(1)
        self.browser.find_element_by_xpath('//input[@ng-model="package.securityName"]').send_keys(SafeBagData.safe_bag)
        sleep(1)
        ...
        print(resultSafeBag),
        sleep(1)
        self.assertEqual(resultSafeBag, SafeBagData.safe_bag, msg="添加的安全包与网页上显示的不同！")
